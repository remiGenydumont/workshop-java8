...
//        		.anyMatch((o)->{
//        			Boolean pizzaOver1300 = false;
//        			return pizzaOver1300 ;
//        		});
    ...
    public void test_stream_max() throws Exception {
        ...
        Comparator<Pizza> compPizza = Comparator.comparing(Pizza::getPrice)
                .thenComparing(Pizza::getName)
                .thenComparing(Pizza::getId);
        // TODO Trouver la pizza la plus chère
        Optional<Pizza> result = pizzas.stream().max(compPizza);
    ...
    public void test_stream_min() throws Exception {
        ...
        Optional<Pizza> result = pizzas.stream().filter((p)->p.getPrice() >= 950).min(compPizza);
