...
public class Stream_03_Test {
    ...
    public void test_mapping() throws Exception {
        ...
        List<Customer> customers = new Data().getCustomers();
        Comparator<Customer> compCustomer = Comparator.comparing(Customer::getFirstname)
        ...
        Map<Gender, String> result = customers.stream().sorted(compCustomer).collect(Collectors.toMap(Customer::getGender,Customer::getFirstname, (c1, c2) -> c1+"|"+2));
